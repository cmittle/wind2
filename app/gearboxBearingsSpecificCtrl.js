...
/*$scope.openDetail = function (p,size) {
        var modalInstance = $uibModal.open({
            ...
            controller: 'gearboxSpecificsCtrl2',   //gearboxBearingSpecificEditCtrl
            size: size,
            resolve: {
                item: function () {
                    return p;
    ...
    $scope.init = function () {
        ...
        //console.log("gearboxBearingSpecificsCtrl.js works");
...
app.controller('gearboxBearingSpecificEditCtrl', function ($scope, $uibModalInstance, $http, $routeParams, item, Data) {
